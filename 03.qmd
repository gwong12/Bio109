...
| Term       | Definition                                                   |
+============+==============================================================+
| Cytoplasm  | all material within eukaryotic cell, except for nucleus      |
|            |                                                              |
|            | -   inside of cell between plasma membrane and nucleus       |
+------------+--------------------------------------------------------------+
| Cytosol    | liquid medium of cytoplasm                                   |
+------------+--------------------------------------------------------------+
| Organelles | membrane enclosed structures that perform functions for cell |
+------------+--------------------------------------------------------------+
...
| Term | Definition |
|----|----|
| Rough Endoplasmic Reticulum | translation & folding of new proteins |
| Smooth Endoplasmic Reticulum | lipid synthesis & detoxification of metabolic byproducts |
| Golgi apparatus | process, modify, package proteins & lipids for transport (out or within cell) |
| Mitochondrion | generate energy for cell |
| Lysosomes | breakdown large molecules (ex: proteins, polysaccharides) |
| Peroxisomes | breakdown metabolic hydrogen peroxide |
| Microfilaments | thickest of cytoskeletal filaments; composed of actin subunits that function in muscle contraction & cellular structural support |
| Microtubules | thickest of cytoskeletal filaments; composed of tubulin subunits that function in cellular movement & structural support |
| Cilia | small appendage on certain cells formed by microtubules & modified for movement of materials across cellular surface |
| Flagella | tail-like structure formed by microtubules used for movement |
| Nucleus | DNA maintenance, controls cell activities, RNA transcription |
| Nucleolus | small region of nucleus that functions in ribosome synthesis |

### **Membrane Transport**

-   Passive Transport: transport across cell membrane that does not require energy
-   Active Transport: transport that requires input of cellular energy
-   Diffusion: movement of particles from high to low concentration
    -   moves down or along concentration gradient
-   Osmosis: diffusion of water across semi-permeable membrane
-   Cell Cycle: life cycle of single cell, from birth to division into 2 cells
-   Interphase: when cell is not dividing and performing normal functions
-   Mitosis: cell division for growth and repair

### **Stages of Interphase and Mitosis**

-   Interphase: when cell is not dividing
-   G1 phase: 1st phase of cell cycle after new cell is born (growth, metabolism)
-   S phase: DNA replication
-   G2 phase: 3rd phase, after DNA synthesis (growth of structural elements)
...
|----|----|----|
| Prophase | dissolution of nucleus, chromosome condensation, centrioles arrange spindle |  |
| Metaphase | chromosomes arranged along equator of cell |  |
| Anaphase | duplicate chromosomes pulled apart to either pole |  |
| Telophase | nuclei reform, chromosomes loosen into chromatin |  |
| Cytokinesis | cytoplasm divides to form 2 separate daughter cells |  |
...
-   What are the primary macromolecules that make up the membrane? lipids, carbohydrates, proteins
-   What are the functions of the following components:
    -   Phospholipids: create nonpolar zone
    -   Cholesterol: maintain internal fluidity
    -   Proteins: transport, enzymes, hormones, structure
...
+==============================+==============+=====================================================================================================================+
| Plasma membrane              |              | border of cell                                                                                                      |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Cilia                        |              | movement of materials across cellular surface                                                                       |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Microvilli                   |              | folded extensions of plasma membrane                                                                                |
|                              |              |                                                                                                                     |
|                              |              | -   increase surface area for greater rates of transport                                                            |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Nucleolus                    |              | small region of nucleus that functions in ribosome synthesis                                                        |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Nucleus                      |              | DNA maintenance, controls cell activities, RNA transcription                                                        |
...
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Nuclear pore                 |              | protein lined opening on nuclear envelope                                                                           |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Ribosome                     |              | protein synthesis                                                                                                   |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Vesicle                      |              | membrane bound structure that transports material within or outside cell                                            |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Peroxisome                   |              | breakdown metabolic hydrogen peroxide                                                                               |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Lysosome                     |              | breakdown large metabolic molecules                                                                                 |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Golgi apparatus              |              | process, modify, package proteins & lipids for transport                                                            |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Mitochondrion                |              | generate energy                                                                                                     |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Rough endoplasmic reticulum  |              | translation & folding of new proteins                                                                               |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Smooth endoplasmic reticulum |              | lipid synthesis & detoxification of metabolic byproducts                                                            |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
| Centriole                    |              | anchor for cytoskeleton, organizes cell division by forming spindle fibers (only visible when division takes place) |
+------------------------------+--------------+---------------------------------------------------------------------------------------------------------------------+
...
| Name                                         | Description                                                                                                     |
+==============================================+=================================================================================================================+
| 1\) \_\_\_\_\_F\_\_\_\_\_ Interphase         | a\) The first stage of mitosis                                                                                  |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 2\) \_\_\_\_\_E\_\_\_\_\_ G2 Phase           | b\) The division of the cytoplasm of a cell                                                                     |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 3\) \_\_\_\_\_I\_\_\_\_\_ Metaphase          | c\) The cell grows physically larger, making the molecular building blocks it will need in later steps.         |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 4\) \_\_\_\_\_D\_\_\_\_\_ S phase            | d\) Occurs when the cell synthesizes a complete copy of the DNA.                                                |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 5\) \_\_\_\_\_G\_\_\_\_\_ Mitosis or M phase | e\) The cell grows a second time to reorganize its contents in preparation for mitosis.                         |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 6\) \_\_\_\_\_A\_\_\_\_\_ Prophase           | f\) The summary of the G1, S, G2 phases                                                                         |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 7\) \_\_\_\_\_C\_\_\_\_\_ G1 phase           | g\) The process when the cell separates its DNA into two sets and divides its cytoplasm, forming two new cells. |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 8\) \_\_\_\_\_\_B\_\_\_\_ Cytokinesis        | h\) Observed when the chromosomes move toward opposite ends of the nuclear spindle                              |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 9\) \_\_\_\_\_J\_\_\_\_\_ Telophase          | i\) Occurs when the cell's chromosomes condense and move together, aligning in the center of the dividing cell. |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 10\) \_\_\_\_\_H\_\_\_\_\_ Anaphase          | j\) The final stage in cell division                                                                            |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
...
| 1\) \_\_\_\_\_F\_\_\_\_\_ Interphase         | a\) The first stage of mitosis                                                                                  |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 2\) \_\_\_\_\_\_C\_\_\_\_ G2 Phase           | b\) The division of the cytoplasm of a cell                                                                     |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 3\) \_\_\_\_\_D\_\_\_\_\_ Metaphase          | c\) The cell grows physically larger, making the molecular building blocks it will need in later steps.         |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 4\) \_\_\_\_\_\_B\_\_\_\_ S phase            | d\) Occurs when the cell synthesizes a complete copy of the DNA.                                                |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 5\) \_\_\_\_\_G\_\_\_\_\_ Mitosis or M phase | e\) The cell grows a second time to reorganize its contents in preparation for mitosis.                         |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 6\) \_\_\_\_\_A\_\_\_\_\_ Prophase           | f\) The summary of the G1, S, G2 phases                                                                         |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 7\) \_\_\_\_\_\_C\_\_\_\_ G1 phase           | g\) The process when the cell separates its DNA into two sets and divides its cytoplasm, forming two new cells. |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 8\) \_\_\_\_\_B\_\_\_\_\_ Cytokinesis        | h\) Observed when the chromosomes move toward opposite ends of the nuclear spindle                              |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 9\) \_\_\_\_\_J\_\_\_\_\_ Telophase          | i\) Occurs when the cell's chromosomes condense and move together, aligning in the center of the dividing cell. |
+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
| 10\) \_\_\_\_\_H\_\_\_\_\_ Anaphase          | j\) The final stage in cell division                                                                            |
