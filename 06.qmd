...
-   Epiphysis: wide section at each end of long bone
-   Diaphysis: tubular shaft that runs between proximal & distal ends of long bone
-   Compact bone: dense osseous tissue that can withstand compressive forces
-   Spongy bone: trabeculated osseous tissue that supports shifts in weight distribution
    -   network of struts & plates (trabeculae)
-   Hyaline (articular) cartilage: thin layer covering epiphysis
    -   reduces friction & acts as shock absorber
-   Periosteum: fibrous membrane covering outer surface of bone & continuous with ligaments
-   Bone processes: general term for projection
    -   marking where part of surface sticks out above rest of surface
    -   where tendons & ligaments attach
-   Medullary cavity: hollow region of diaphysis; filled with yellow marrow
-   Yellow marrow: connective tissue in interior cavity of bone where fat is stored
-   Red marrow: connective tissue in interior cavity where hematopoiesis takes place
    -   blood cell production
-   Epiphyseal plate: sheet of hyaline cartilage in metaphysis of immature bone; replaced by bone tissue as organ grows in length
-   Endosteum (simple squamous): delicate membranous lining of bone's medullary cavity
...
| Term              | Definition                                                      |
+===================+=================================================================+
| Osteocytes        | primary cell in mature bone; responsible for maintaining matrix |
+-------------------+-----------------------------------------------------------------+
| Matrix            | extracellular protein fibers & ground substance                 |
+-------------------+-----------------------------------------------------------------+
| Collagen fibers   | 1/3 of bone mass                                                |
|                   |                                                                 |
|                   | -   flexibility, strength vs tension                            |
|                   |                                                                 |
|                   | -   bends if compressed                                         |
+-------------------+-----------------------------------------------------------------+
| Calcium phosphate | 2/3 mass of bone                                                |
|                   |                                                                 |
|                   | -   contributes strength vs compression                         |
|                   |                                                                 |
...
| Term           | Definition                                                                          |
+================+=====================================================================================+
| Long bones     | cylinder-shaped bone that is longer than it is wide (lever)                         |
+----------------+-------------------------------------------------------------------------------------+
| Short bones    | cube-shaped bone approx. equal in length, width, thickness                          |
|                |                                                                                     |
|                | -   limited motion provided                                                         |
+----------------+-------------------------------------------------------------------------------------+
| Flat bones     | thin & curved; serves as point of attachment for muscles & protects internal organs |
+----------------+-------------------------------------------------------------------------------------+
| Irregular      | complex shape; protects internal organs from compressive forces                     |
+----------------+-------------------------------------------------------------------------------------+
| Sesamoid bones | small, round bone embedded in tendon; protects tendon from compressive forces       |
+----------------+-------------------------------------------------------------------------------------+
...
+================+============================================================+=====================================+
| Long           | Cylindrical shape; longer than wide                        | femur                               |
+----------------+------------------------------------------------------------+-------------------------------------+
| Short          | Cube shaped length, width, and thickness; relatively equal | carpal                              |
+----------------+------------------------------------------------------------+-------------------------------------+
| Flat           | Thin and wide curved                                       | frontal, sternum                    |
+----------------+------------------------------------------------------------+-------------------------------------+
| Irregular      | Complex shape                                              | vertebra                            |
+----------------+------------------------------------------------------------+-------------------------------------+
...
-   What are the major anatomical differences between spongy and compact bone?
    -   spongy: porous, inner volume of epiphyses
    -   compact: dense, inner volume of long bones
...
-   **4** A bony bulb or structure on a narrow neck is called a(n) \_\_head\_\_\_. (4)

-   **6** On a bone, a(n) \_\_\_process\_\_ is a structure which protrudes from a bone. These are often named for what they protrude toward. (7)

-   **7** On the femur, a(n) \_\_trochanter\_\_\_ refers to a large, blunt, unevenly shaped process. (10)

-   **8** A sharp, axe-like or needle-like projection on a bone is called a(n) \_\_spine\_\_\_. (5)

### **Down**

-   **1** On a bone, a(n) \_\_fissure\_\_\_ is a deep groove or notch. (7)

-   **2** The flat, smooth face on a bone where it meets another bone is called a(n) \_\_facet\_\_\_. (5)

-   **3** On a bone, a(n) \_\_\_crest\_\_ is a narrow ridge. A(n) \_\_\_line\_\_ is a smaller version. (5,4)

-   **5** A raised area on a condyle is called a(n) \_\_\_epicondyle\_\_. (10)
...
**6** Compact bone consists of long, multi-layered cylinders called \_\_\_osteons\_\_, surrounded by a central, blood-vessel and nerve-containing canal called the \_\_Haversian canals\_\_\_. (7,9,6)

**7** Blood vessels and nerves may move from one Haversian canal to another by detouring through a(n) \_\_\_perforating canal\_\_. (11,5)

### **Down**

**1** Mature bone cells are called \_\_osteocytes\_\_\_ (10)

**2** Young, dividing cells usually have names that end in \_\_\_blast\_\_; mature cells usually have names that end in \_\_\_cytes\_\_. (10)

**3** Osteocytes in lacunae within an osteon maintain contact with one another by extending processes through \_\_canaliculi\_\_\_. (10)

**4** Cells that dissolve bone are called \_\_osteoclasts\_\_\_. (11)

**5** Bone-building cells are called \_\_osteoblasts\_\_\_. (10)
...
+===================+========================================================================================================================================+=======================+
| Articular         | \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ cartilage covers ends of long bones.                                                                    | a\) axial             |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Perichondrium     | Skeletal cartilage is enclosed by the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_,                                                                  | b\) hyaline cartilage |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Appendicular      | The bones of the limbs, shoulders, and hips make up the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ skeleton.                                       | c\) epiphyseal line   |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Epiphyses         | Cancellous bone is found in the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ of long bones.                                                          | d\) Articular         |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Yellow marrow     | \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ is found in the central (medullary) cavity of an adult's long bones and is composed of fat.             | e\) perichondrium     |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Hyaline cartilage | Articular cartilage is composed of \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.                                                                     | f\) diaphysis;        |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Endosteum         | The inner surface of the bone, where it meets the marrow, is covered by a delicate membrane called the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_. | g\) Yellow marrow     |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Diaphysis         | The tubular shaft that forms the axis of long bones is called the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.                                      | h\) appendicular      |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Axial             | The bones of the skull, rib cage, and vertebral column make up the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ skeleton                             | i\) epiphyses         |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
| Epiphyseal line   | The line that separates the diaphysis from the epiphysis in a long bone is called the \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_.                  | j\) endosteum         |
+-------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
